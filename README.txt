...
Add your address via Devices to see which containers (GFT, Restafval, Papier, PBD) are collected today and tomorrow. Use the widget on your Homey dashboard for a quick overview, and set up Flows to receive a notification on collection days.

Works for all addresses in the Netherlands.
